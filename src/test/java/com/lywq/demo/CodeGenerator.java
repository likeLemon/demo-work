 ...
 * @author: lywq WED
 * @time: 2019/11/5 22:57
 */
public class CodeGenerator {

    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/recruit?serverTimezone=GMT%2B8";
    ...
    // @author
    private static final String AUTHOR = "卢程程";
    // @date
    ...
    private static SqlMapGeneratorConfiguration getSqlMapGeneratorConfiguration() {
        ...
        sqlMapGeneratorConfiguration.setTargetPackage(ProjectConstant.MAPPERXML_PACKAGE);
